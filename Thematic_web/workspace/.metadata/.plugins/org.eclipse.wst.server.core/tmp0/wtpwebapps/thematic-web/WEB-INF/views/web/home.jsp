	...
	<!--BODY CONTENT  -->
        ...
        <section class="">
            <div class="container px-2 px-lg-5 mt-4">
		                        ...
		                        <div class="card-body p-4">
		                         ...
		                         <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
		                         	<div class="text-center">
			                         	...
			                         	style="background: #00bfff; border-style: solid; border-color: hsl(1, 0%, 73%);">
			                         		Xem bài viết
			                         	</a>
		                         	</div>
		                         </div>
                ...
                <button type="button" class="btn mb-3 mt-2 w-100" id="btnLoadMore" 
                style="background: #00bfff; border-style: solid; border-color: hsl(1, 0%, 73%);">Xem thêm</button> 
            </div>
        </section>
