				...
				<table id="cart" class="table table-hover table-condensed">
			    	...
			    	<thead>
				      <tr>
				        ...
				        <th style="width:10%; color: white"><h5>Hình ảnh</h5></th>
				        <th style="width:50%; color: white"><h5>Bài viết</h5></th>
				        <th style="width:10%; color: white"><h5>Thể loại</h5></th>
				        <th style="width:11%; color: white"><h5>Số lượng</h5></th>
				        <th style="width:10%; color: white" class="text-center"><h5>Tác giả</h5></th>
				        <th style="width:7%; color: white"></th>
				      </tr>
			    	</thead>
				    	<tbody>
				    	<c:forEach var="item" items="${cart.listNews}">
				    			
						      <tr class= "news card-body " style="background: #f7fafb; margin-bot: 10px">
						      	<td class="center">
											<label class="pos-rel">
								...
								<td data-th="Thumbnail">
									<div class="col-sm-2 hidden-xs">
						           		<img src="${item.thumbnail}" alt="..." class="img-responsive" style="height:100px; "/>
						            </div>
								 </td>
						        ...
						        <button class="btn btn-primary" title="Xem bài viết" style="width: 100px">
						          	<a href="<c:url value='/bai-viet?id=${item.id}' />" style="color:white">
			                         	 Xem bài viết<i class="fa fa-refresh"></i>
			                      	</a>
						        </button>
			...
			<c:if test="${cart.listNews.size() ==0}">
			 ...
			 <div class="modal-footer">
	                ...
	                <button type="button" class="btn btn-primary" style="width: 30%">
	               		<a href="<c:url value='trang-chu' />" style="color:white">Quay lại trang chủ 
