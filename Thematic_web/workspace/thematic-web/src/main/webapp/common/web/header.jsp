            ...
            <div class="collapse navbar-collapse " id="navbarSupportedContent">
                ...
                <form class="d-flex ">
                	...
                	<!-- data-toggle="modal" 
                    	...
                    	<button class="btn btn-outline-light" type="button" id="cart" >
	                    	<a href="<c:url value='/gio-hang' />" style="color: white">
	...
	<nav class=" navbar navbar-expand-lg navbar-dark bg-secondary  border-bottom-2 border-2 border-secondary">
            <div class="container collapse navbar-collapse px-4 px-lg-5 " id="navb">
               ...
               <%--      <c:forEach var="item" items="categories"> --%>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="<c:url value='/the-loai?categoryCode=chuyen-nhuong' />">Chuyển nhượng</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="<c:url value='/the-loai?categoryCode=lich-phat-song' />">Lịch phát sóng</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="<c:url value='/the-loai?categoryCode=khac' />">Khác</a>
                        </li>
                    <%--  </c:forEach> --%>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                ...
                                <li><a class="dropdown-item" href="<c:url value='/the-loai?categoryCode=cau-thu' />">Cầu thủ</a></li>
                                      <li><a class="dropdown-item" href="<c:url value='/the-loai?categoryCode=huan-luyen-vien' />">Huấn luyện viên</a></li>
                                <li><a class="dropdown-item" href="<c:url value='/the-loai?categoryCode=doi-bong' />">Đội bóng</a></li>
